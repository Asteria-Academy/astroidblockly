...
class AppRoutes {
  ...
  static const challengeSelect = '/challenge-select';
}
...
Route<dynamic> onGenerateRoute(RouteSettings settings) {
  switch (settings.name) {
    ...
    case AppRoutes.missionControl:
      ...
      return _page(
        MissionControlScreen(projects: projects, controller: controller),
      );
    ...
    case AppRoutes.challengeSelect:
      return _page(const LevelSelectionScreen());
